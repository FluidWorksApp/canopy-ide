...
fn build_menu(app: &tauri::AppHandle) -> tauri::Result<Menu<tauri::Wry>> {
    ...
    let tabs = Submenu::with_items(
        ...
        &[
            ...
            &PredefinedMenuItem::separator(app)?,
            &MenuItem::with_id(app, "jump-tab-1", "Jump to Tab 1", true, Some("CmdOrCtrl+1"))?,
            &MenuItem::with_id(app, "jump-tab-2", "Jump to Tab 2", true, Some("CmdOrCtrl+2"))?,
            &MenuItem::with_id(app, "jump-tab-3", "Jump to Tab 3", true, Some("CmdOrCtrl+3"))?,
            &MenuItem::with_id(app, "jump-tab-4", "Jump to Tab 4", true, Some("CmdOrCtrl+4"))?,
            &MenuItem::with_id(app, "jump-tab-5", "Jump to Tab 5", true, Some("CmdOrCtrl+5"))?,
            &MenuItem::with_id(app, "jump-tab-6", "Jump to Tab 6", true, Some("CmdOrCtrl+6"))?,
            &MenuItem::with_id(app, "jump-tab-7", "Jump to Tab 7", true, Some("CmdOrCtrl+7"))?,
            &MenuItem::with_id(app, "jump-tab-8", "Jump to Tab 8", true, Some("CmdOrCtrl+8"))?,
            &MenuItem::with_id(app, "jump-tab-9", "Jump to Last Tab", true, Some("CmdOrCtrl+9"))?,
            &PredefinedMenuItem::separator(app)?,
